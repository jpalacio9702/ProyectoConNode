...
console.log( "1. ", moment( febrero ).locale( "es" ).format( "MMMM DD YYYY" ) );
console.log( "2. ", moment( febrero ).locale( "es" ).format( "dddd" ) );
console.log( "3. ", moment( febrero, "YYYYMMDD" ).locale( "es" ).fromNow());
